...
import uk.gov.justice.digital.hmpps.community.controllers.CommunityProxyResource;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public Docket api() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage(CommunityProxyResource.class.getPackage().getName()))
